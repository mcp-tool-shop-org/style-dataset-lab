...
डेटासेट पाइपलाइन चलने से पहले, `sdlab canon *` नेमस्पेस आपके प्रोजेक्ट के मानक इकाई भंडार को उन तीन अनुमानों में बदल देता है जिनका वास्तव में प्रशिक्षण और उत्पादन में उपयोग किया जाता है — और उन प्रविष्टियों को लॉक कर देता है जिन्हें बदलना नहीं चाहिए।
...
| **Training package** | एडेप्टर के माध्यम से ट्रेनर-तैयार लेआउट (`diffusers-lora`, `generic-image-caption`)। समान सत्य, अलग प्रारूप। |
...
- **[Tallow Fen](handbook/case-study-tallow-fen/)** (जीव-डिजाइन) — एक स्क्रैच से बनाया गया सर्वश्रेष्ठ प्राणी मानक, 293 क्यूरेट किए गए रिकॉर्ड में लगभग 34% स्वीकृति (169 अस्वीकृत — गेट कठिन रूप से अस्वीकार करता है)। `qwen-image` पर 1.5 पर `tallow_fen_style_v3.safetensors` भेजा गया।
- **[Rustline](handbook/case-study-rustline/)** (अवधारणा-डिजाइन) — घनी, पहले से निर्मित मानक, 180 रिकॉर्ड में लगभग 96% स्वीकृति। `qwen-image` पर 1.0 पर `rustline_v3ckpt_1500.safetensors` भेजा गया, बाद में एक दूसरे प्रोजेक्ट द्वारा पुन: उपयोग किया गया।
...
- **स्नैपशॉट अपरिवर्तनीय हैं।** कॉन्फ़िगरेशन फ़िंगरप्रिंट (SHA-256) साबित करता है कि कुछ भी नहीं बदला।
...
- **रन अपने सटीक ग्राफ़ को पिन करते हैं।** प्रत्येक पीढ़ी `comfy_workflow_sha` + मॉडल/LoRA सामग्री हैश + बीज नीति रिकॉर्ड करती है, इसलिए एक लहर बाइट-दर-बाइट दोहराने योग्य होती है - JS और Python रनर दोनों में समान। मॉडल हैशिंग वैकल्पिक है (`--hash-models`) और कभी भी मनगढ़ंत नहीं होता है।
- **कोई भी मॉडल अपने स्वयं के आउटपुट को सत्यापित नहीं करता है।** निर्णय `judged_by_model` और `generator_model` रिकॉर्ड करते हैं; यदि वे कभी एक ही मॉडल होते हैं तो एक चेतावनी जारी होती है।
...
`sdlab` डेटासेट का मालिक है। प्रारूप रूपांतरण [`repo-dataset`](https://github.com/mcp-tool-shop-org/repo-dataset) द्वारा संभाला जाता है: TRL, LLaVA, Qwen2-VL, JSONL, Parquet और अन्य। `repo-dataset` प्रस्तुत करता है; यह कभी भी समावेश का निर्णय नहीं लेता है।
...
यदि आप `--project` भूल जाते हैं, तो CLI `projects/` के तहत पाए जाने वाले पहले प्रोजेक्ट पर वापस आ जाता है और एक चेतावनी प्रिंट करता है - इसे चुप कराने के लिए स्पष्ट रूप से `--project` पास करें।
...
ComfyUI नहीं चल रहा है। ComfyUI शुरू करें (`python main.py --listen 127.0.0.1 --port 8188`) और `curl http://127.0.0.1:8188/system_stats` से पुष्टि करें। किसी भिन्न होस्ट/पोर्ट पर इंगित करने के लिए, `COMFY_URL=http://host:port` सेट करें।
...
- `E_PROJECT_NOT_FOUND` - परियोजना निर्देशिका `projects/` के तहत मौजूद नहीं है। वर्तनी की जाँच करें।
