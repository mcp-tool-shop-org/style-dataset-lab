 ...
 *   - freeze_watch_defaults: per-schema default watch_fields for the freeze
 *     witness chain (D5). Consumed by lib/freeze-stamp.js:resolveWatchFields.
 */
...
export async function loadBuildConfig(configPath, projectRoot) {
  ...
  return {
    ...
    freeze_watch_defaults: config.freeze_watch_defaults || {},
