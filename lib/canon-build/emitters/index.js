...
import { emitFaction } from './faction.js';
import { emitShip } from './ship.js';
import { emitSpecies } from './species.js';
...
export const EMITTERS = {
  ...
  'faction.schema.json': emitFaction,
  'ship.schema.json': emitShip,
  'species.schema.json': emitSpecies,
};
...
export { emitMonster, emitCharacter, emitDeity, emitLocation, emitRelic, emitFaction, emitShip, emitSpecies };
