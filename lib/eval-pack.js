...
import { computeConfigFingerprint, SCHEMA_VERSION, checkManifestVersion } from './snapshot.js';
...
export async function buildEvalPack(projectRoot, options = {}) {
  ...
  if (existsSync(evalDir)) {
    throw inputError(
      'EVAL_PACK_ID_COLLISION',
      `Eval pack directory already exists: ${evalDir}`,
      'Retry to generate a fresh eval pack ID.',
    );
  }
