...
out = Path(r"E:/AI/style-dataset-lab/projects/hesperia/outputs/npcs-wave-3")
ids = ["forgebrand", "spoolcraft", "hearthcoal", "vira_keld", "sprocketveil", "echohaven",
       "keelwright", "rhea_mott", "gail_voss", "mirevault", "jonas_creel", "jace", "pip"]
tiles = []
for i in ids:
    for v in (0, 1):
        p = out / f"{i}_v{v}.png"
...
print("wave3 contact:", out / "_contact_sheet.png", sheet.size)
